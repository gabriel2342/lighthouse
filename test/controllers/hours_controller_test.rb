...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference("Hour.count") do
      post hours_url, params: { hour: { closes: @hour.closes, day: @hour.day, opens: @hour.opens } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { closes: @hour.closes, day: @hour.day, opens: @hour.opens } }
